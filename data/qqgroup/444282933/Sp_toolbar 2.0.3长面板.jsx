        ...
        for (var i = 0; i < thisXml.children().length(); i++) {
            ...
            ic.addEventListener("mouseup", function (k) {
                if (k.button == 2 && this.hasMulti == 1) {
                    ...
                    thisDrop.preferredSize = [150, 300];
                    thisDrop.removeAll();
                    ...
                    sp_toolbar.newWin.preferredSize.width = 300;
    ...
    alignment: ['fill', 'fill'], alignChildren: ['fill', 'fill'],
        ...
        text: '"""+(special_loc>>special_str.toolbars)+"""',
            ...
            orientation: 'row', alignment: ['fill', 'fill'], alignChildren: ['right', 'buttom'], magins: 1, spacing: 3,
                create:IconButton{ text: 'Add', size: [30, 30] },
            del:IconButton{ text: 'Del', size: [30, 30] },
            up:IconButton{ text: 'Up', size: [30, 30] },
            down:IconButton{ text: 'Down', size: [30, 30] }
        },
        gr2:Group{
            alignment: ['fill', 'fill'], alignChildren: ['fill', 'fill'],
        ...
        gr3:ListBox{ alignment: ['fill', 'fill'], alignChildren: ['fill', 'fill'], size: [undefined, '450'] }
    },
    gr2:Panel{
